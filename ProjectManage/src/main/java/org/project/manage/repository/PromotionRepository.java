...
public interface PromotionRepository extends JpaRepository<Promotion, Long> {
	...
	@Query(nativeQuery = true, value = "SELECT p.* FROM promotion p  where p.product_category_id =:productCategoryId and p.user_type =:userType and SYSDATETIME() BETWEEN start_date  AND end_date")
